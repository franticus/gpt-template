...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Piazzolla:ital,wght@0,300;0,400;0,500;0,600;0,700;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
	...
	<style>
		* {
		...
		.bodyClass1-fgZSxP4y{
			background-image: linear-gradient(to bottom, #13101c, #1c1429, #1a162e, #130f1a, #000000);
			color: #ffffff;
		}
		.bodyClass2-fgZSxP4y{
			background: #045757;
...
<p class="cBlock-fgZSxP4y"><span class="domain-fgZSxP4y"></span></p>
	...
	<script>var domainElements = document.getElementsByClassName("domain-fgZSxP4y");
